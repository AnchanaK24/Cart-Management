...
const products= [
    new Product({
        imagePath: '/images/mobiles/mobiles1.jpg',
        title: 'REALME',
        description: 'Nice Mobile',
        price: 10000
    }),
    new Product({
        imagePath: '/images/mobiles/mobiles2.jpg',
        title: 'Samsung-Galaxy',
        description: 'Nice',
        price: 15000
    }),
    new Product({
        imagePath: '/images/mobiles/mobiles3.jpg',
        title: 'Vivo',
        description: 'Good Quality',
        price: 12000
    }),
    new Product({
        imagePath: '/images/storybooks/storybooks1.jpg',
        title: 'Bed book',
        description: 'Nice Book',
        price: 100
    }),
    new Product({
        imagePath: '/images/storybooks/storybooks2.jpg',
        title: 'Charlottes-Web',
        description: 'Awesome One',
        price: 150
    }),
    new Product({
        imagePath: '/images/storybooks/storybooks3.jpg',
        title: 'Jungle Book',
        description: 'Good',
        price: 200
    }),
    new Product({
         imagePath:'/images/storybooks/storybooks4.jpg',
        title: 'prevention-of-justice',
        description: 'Nice',
        price: 250
    })
]
